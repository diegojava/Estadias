  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="/Estadias/admin"><i class="fa fa-link"></i> <span>Página principal</span></a></li>
        <li class="active"><a href="/Estadias/admin/graphs.php"><i class="fa fa-link"></i> <span>Gráficas</span></a></li>
        <li class="treeview">
