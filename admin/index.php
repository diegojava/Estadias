...
<head>
  ...
  <title>Aprende Jugando | Panel de Administración</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="/Estadias/"><i class="fa fa-dashboard"></i> <span>Página principal</span></a></li>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <h3>
              ...
              $sql = "SELECT count(*) as total FROM alumnos WHERE rol = 1";
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3>
                ...
                $sql = "SELECT count(*) as total FROM alumnos WHERE isActivo = 0 AND rol = 1";
                $result = $conn->query($sql);
